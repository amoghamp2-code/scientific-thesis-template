...
The following provides condensed answers to each research question. Detailed evidence and test references are provided in Section~\ref{sec:rq-evaluation}. An expanded mapping with full traceability is available in Appendix~\ref{sec:appendix-rq-evidence}.
...
The following limitations apply to the thesis as a whole, consolidated from the conception (Section~\ref{sec:conception-summary}), prototype (Section~\ref{sec:impl-limitations}), and evaluation (Section~\ref{sec:eval-limitations}). A complete categorised list is provided in Appendix~\ref{sec:appendix-limitations}.
